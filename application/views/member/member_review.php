            ...
            <div class="layout-w">
                ...
                <div class="content-w">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php base_url()?>member-review">My Review</a></li>
                    </ul>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">My Review</h6>
                                </div>
                            </div>
                        </div>
                        <div class="content-i">
                            <div class="element-box" style="width: 100%;">
                                <h5 class="form-header">View My Review</h5>
                                                            ...
                                                            foreach ($review as $data) 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        {
                                                                          ?>
                                                                        <span style="color:red;font-size: 13px">Pending</span>
                                                                        <?php
                                                                        }
                                                                        else
                                                                        {
                                                                          ?>
                                                                        <span style="color: green;font-size: 13px;">Active</spann>
                                                                        <?php  
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
                                                                        <a onclick="$('#delete-link').attr('href','<?php echo base_url() ?>delete/memberreview/<?php echo $data->review_id; ?>')" style="text-decoration: none" data-toggle="tooltip" title="Remove Data">
