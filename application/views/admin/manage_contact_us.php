                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="element-wrapper">
                                        <h6 class="element-header">Manage Contact Us</h6>
                                        <div class="content-i">
                                            <div class="element-box" style="width: 100%;">
                                                <h5 class="form-header">View All Contact</h5>
                                                        ...
                                                        <tbody style="text-align: center;vertical-align: middle">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a onclick="$('#delete-link').attr('href','<?php echo base_url(); ?>delete/contact/<?php echo $data->contact_id; ?>')" style="text-decoration: none" data-toggle="tooltip" title="Remove Data">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p style="text-transform: capitalize;">Are you sure want to delete contact ?</p>
                                                            </div>
