...
class Mymodel extends CI_Model
{
    ...
    public function my_mailer($to , $subject , $message )
    {
        $config = Array(
          ...
          'smtp_port' => 465,
          'smtp_user' => 'agricultureportal2044@gmail.com', // change it to yours
          'smtp_pass' => 'Agri2044.com', // change it to yours
          'mailtype' => 'html',
          'charset' => 'iso-8859-1',
          'wordwrap' => TRUE
        );
        ...
        $this->email->from('agricultureportal2044@gmail.com'); // change it to yours
